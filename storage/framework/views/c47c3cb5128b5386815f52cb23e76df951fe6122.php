...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo asset('assist/css/signup.css'); ?>"/>
		<!--[if lt IE 9]>
    ...
    <body>
        ...
        <script src="<?php echo asset('assist/js/signup.js'); ?>"></script>
        <script src="<?php echo asset('assist/js/signout.js'); ?>"></script>
    </body>
</html><?php /**PATH C:\xampp\htdocs\dashbordProject\resources\views/signup.blade.php ENDPATH**/ ?>