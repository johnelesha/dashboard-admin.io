...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo asset('assist/css/index.css'); ?>"/>
        <!--[if lt IE 9]>
    ...
    <body>
        <div class="logohead">
            <img src="<?php echo asset('assist/images/Logo%201.png'); ?>"/>
        </div>
        ...
        <script src="<?php echo asset('assist/js/index.js'); ?>"></script>
    </body>
</html><?php /**PATH C:\xampp\htdocs\dashbordProject\resources\views/index.blade.php ENDPATH**/ ?>