    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark nav-justified">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" id="adminlink" href="">Admins</a>
                    </li>
                    <li class="nav-item">
        ...
        <script src="<?php echo asset('assist/js/admins.js'); ?>"></script>
        <script src="<?php echo asset('assist/js/signout.js'); ?>"></script>
    </body>
</html><?php /**PATH C:\xampp\htdocs\dashbordProject\resources\views/admins.blade.php ENDPATH**/ ?>