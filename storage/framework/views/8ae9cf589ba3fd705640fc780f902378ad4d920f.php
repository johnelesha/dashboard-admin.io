...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo asset('assist/css/showdata.css'); ?>"/>
		<!--[if lt IE 9]>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark nav-justified">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" id="restaurantlink" href="">Restaurants</a>
                    </li>
                    <li class="nav-item">
        ...
        <script src="<?php echo asset('assist/js/restaurants.js'); ?>"></script>
        <script src="<?php echo asset('assist/js/signout.js'); ?>"></script>
    </body>
</html><?php /**PATH C:\xampp\htdocs\dashbordProject\resources\views/restaurants.blade.php ENDPATH**/ ?>