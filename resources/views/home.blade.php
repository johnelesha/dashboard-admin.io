...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{!!asset('assist/css/home.css')!!}"/>
		<!--[if lt IE 9]>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark">
            <a class="navbar-brand" href="" id="realhome" ><img src="{!!asset('assist/images/Logo%201.png')!!}" alt="Home" title="home"/></a>
        ...
        <section id="secdash">
            <div class="row">
                <div class="col-md-3" id="line">
                    <img src="{!!asset('assist/images/AdministratorMale.png')!!}" id="avatar"/>
        ...
        <script src="{!!asset('assist/js/home.js')!!}"></script>
