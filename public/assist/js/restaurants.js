...
$('#restaurantlink').click(function (e) {
    "use strict";
    e.preventDefault();
});
...
function addDataToTable(doc, i) {
    ...
    td2.textContent = doc.data().address;
...
$("#tbshow").on("click", function (e) {
    "use strict";
    e.stopPropagation();
    var docID = e.target.parentElement.previousElementSibling.previousElementSibling.
        previousElementSibling.previousElementSibling.getAttribute("data-id");
    if (docID !== null) {
        firebase.firestore().collection("checkrestaurant").doc(docID).delete().then(function () {
            window.alert("Delete Success");
            window.location.assign("restadataurants");
        }).catch(function (error) {
